...
namespace ManhattanMorning.Misc
{
    ...
    /// </summary>
    public class FadingAnimation : Animation
    {
        ...
        public FadingAnimation(bool looping, bool reverse, int durationBeforeReverse, bool active, int fadingTime)
        ...
        public FadingAnimation(bool looping, bool reverse, int durationBeforeReverse, bool active, int fadingTime, FadeMode fadeMode)
